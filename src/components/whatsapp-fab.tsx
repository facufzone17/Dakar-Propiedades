...
export function WhatsappFab() {
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 grid size-14 place-items-center rounded-full bg-ink text-white shadow-[0_6px_24px_rgba(23,23,23,0.28)] transition-opacity hover:opacity-90 lg:hidden"
    >
